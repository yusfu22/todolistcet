...
namespace CetToDoList.Controllers
{
    public class TodoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,IsCompleted,DueDate,CatagoryId")] Todo todo)
        {
            ...
            ViewData["CatagoryId"] = new SelectList(_context.Catagories, "Id", "Name", todo.CatagoryId);
            return View(todo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,IsCompleted,DueDate,CatagoryId")] Todo todo)
        {
            if (id != todo.Id)
            {
                return NotFound();
